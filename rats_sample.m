...
file_result = [folder,'\rats_results.xlsx'];
...
kel_ages = [2.5 6 10.5 13 15];         % Use this if the folders are arrange according to age point
...
for i = 1:4, % number of runs
    if ages(i) == 2.5 && strcmp(group(i),'wt'), folder1 = '\Data_Rats\Rats_02mo\Rats_wt';
    elseif ages(i) == 2.5  && strcmp(group(i),'tg'), folder1 = '\Data_Rats\Rats_02mo\Rats_tg';
    elseif ages(i) == 6 && strcmp(group(i),'wt'), folder1 = '\Data_Rats\Rats_06mo\Rats_wt';
    elseif ages(i) == 6 && strcmp(group(i),'tg'), folder1 = '\Data_Rats\Rats_06mo\Rats_tg';
    elseif ages(i) == 10.5 && strcmp(group(i),'wt'), folder1 = '\Data_Rats\Rats_10mo\Rats_wt';
    elseif ages(i) == 10.5 && strcmp(group(i),'tg'), folder1 = '\Data_Rats\Rats_10mo\Rats_tg';
    elseif ages(i) == 13 && strcmp(group(i),'wt'), folder1 = '\Data_Rats\Rats_13mo\Rats_wt';
    elseif ages(i) == 13 && strcmp(group(i),'tg'), folder1 = '\Data_Rats\Rats_13mo\Rats_tg';
    elseif ages(i) == 15 && strcmp(group(i),'wt'), folder1 = '\Data_Rats\Rats_15mo\Rats_wt';
    elseif ages(i) == 15 && strcmp(group(i),'tg'), folder1 = '\Data_Rats\Rats_15mo\Rats_tg';
    end    
    file_name = [char(animal(i)),'_',char(runs(i))];
    result = silhouette_length_3(folder,folder1,file_name,'rats',x_mm_pixel,y_mm_pixel);
...
for d=1:2,
    xlswrite(file_result,{'Group','Animal','Age','Run'},d,'A1')
...
xlswrite(file_result,sil_length,1,'E2')
xlswrite(file_result,gait,1,'F2')
...
xlswrite(file_result,sil_length,2,'E2')
xlswrite(file_result,gait_s,2,'F2')